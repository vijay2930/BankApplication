...
public class UserView implements UserViewCallBack{
    ...
    private void getIncomingRequestsConfirmation() {
        ...
        userController.getIncomingRequests(userName,mtpin);
    }

    private void getMyRequestsConfirmation() {
        System.out.println("Confirm on Getting Request");
        String mtpin=Read.getPinNo("Enter your mtpin: ");
        userController.getMyRequests(userName,mtpin);
    }
    ...
    private void getMyAccountCredential() {
        ...
        userController.getMyAccount(this.userName,mPin);
    }
        ...
        if(requestList.isEmpty()){
            ...
            while (true) {
                try {
                    ...
                    if(choice.equals("1")){
                        userController.acceptingIncomingRequest(request,userName,mtpin,requestList);
                    }else if(choice.equals("2")){
                        userController.cancellingIncomingRequest(request,userName,mtpin,requestList);
                    }
    ...
    @Override
    public void acceptingIncomingRequetFailed(String msg) {
    ...
    private void getTransactionAmount(Account theirAccount) {
        ...
        String mtPin=Read.getPinNo("Enter MTPIN: ");
        userController.checkTransactionIsValid(userName,mtPin,amount,theirAccount);
    }
}
